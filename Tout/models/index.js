...
UserSchema.methods.comparePassword = async function comparePassword(pwd) {
...
const SubscriptionSchema = new mongoose.Schema({
  ...
  paymentMethod: { type: String, enum: ['mtn', 'orange', 'card', 'crypto', 'mobile_money'], default: 'mobile_money' },
